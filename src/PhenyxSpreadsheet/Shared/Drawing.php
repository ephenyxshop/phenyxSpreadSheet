...
class Drawing {
     ...
     */
    public static function pixelsToCellDimension($pixelValue, \PhpOffice\PhenyxSpreadsheet\Style\Font $defaultFont) {
     ...
     * @param \PhpOffice\PhenyxSpreadsheet\Style\Font $defaultFont Default font of the workbook
     *
     * @return int Value in pixels
     */
    public static function cellDimensionToPixels($cellWidth, \PhpOffice\PhenyxSpreadsheet\Style\Font $defaultFont) {
