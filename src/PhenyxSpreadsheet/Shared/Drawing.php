...
class Drawing
{
     ...
     */
    public static function pixelsToCellDimension($pixelValue, \EphenyxShop\PhenyxSpreadsheet\Style\Font $defaultFont)
    {
        // Font name and size
     ...
     * @param \EphenyxShop\PhenyxSpreadsheet\Style\Font $defaultFont Default font of the workbook
     *
     * @return int Value in pixels
     */
    public static function cellDimensionToPixels($cellWidth, \EphenyxShop\PhenyxSpreadsheet\Style\Font $defaultFont)
    {
        // Font name and size
        $name = $defaultFont->getName();
        $size = $defaultFont->getSize();
