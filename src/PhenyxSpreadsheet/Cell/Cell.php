...
use EphenyxShop\PhenyxSpreadsheet\Style\ConditionalFormatting\CellStyleAssessor;
...
class Cell
{
     ...
     *        Note that PhenyxSpreadsheet does not validate that the value and datatype are consistent, in using this
    ...
    public static function setCalculateDateTimeType(int $calculateDateTimeType): void
    {
        switch ($calculateDateTimeType) {
            ...
            case self::CALCULATE_TIME_FLOAT:
                ...
                break;
            default:
                throw new \EphenyxShop\PhenyxSpreadsheet\Calculation\Exception("Invalid value $calculateDateTimeType for calculated date time type");
        }
    }
    ...
    public function getCalculatedValue(bool $resetLog = true)
    {
        if ($this->dataType === DataType::TYPE_FORMULA) {
            try {
                ...
                throw new \EphenyxShop\PhenyxSpreadsheet\Calculation\Exception(
