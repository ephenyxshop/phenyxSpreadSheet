...
use EphenyxShop\PhenyxSpreadsheet\Reader\Xlsx\AutoFilter;
use EphenyxShop\PhenyxSpreadsheet\Reader\Xlsx\Chart;
use EphenyxShop\PhenyxSpreadsheet\Reader\Xlsx\ColumnAndRowAttributes;
use EphenyxShop\PhenyxSpreadsheet\Reader\Xlsx\ConditionalStyles;
use EphenyxShop\PhenyxSpreadsheet\Reader\Xlsx\DataValidations;
use EphenyxShop\PhenyxSpreadsheet\Reader\Xlsx\Hyperlinks;
use EphenyxShop\PhenyxSpreadsheet\Reader\Xlsx\Namespaces;
use EphenyxShop\PhenyxSpreadsheet\Reader\Xlsx\PageSetup;
use EphenyxShop\PhenyxSpreadsheet\Reader\Xlsx\Properties as PropertyReader;
use EphenyxShop\PhenyxSpreadsheet\Reader\Xlsx\SheetViewOptions;
use EphenyxShop\PhenyxSpreadsheet\Reader\Xlsx\SheetViews;
use EphenyxShop\PhenyxSpreadsheet\Reader\Xlsx\Styles;
use EphenyxShop\PhenyxSpreadsheet\Reader\Xlsx\TableReader;
use EphenyxShop\PhenyxSpreadsheet\Reader\Xlsx\Theme;
use EphenyxShop\PhenyxSpreadsheet\Reader\Xlsx\WorkbookView;
...
use EphenyxShop\PhenyxSpreadsheet\Shared\Font;
...
use EphenyxShop\PhenyxSpreadsheet\Style\Font as StyleFont;
use EphenyxShop\PhenyxSpreadsheet\Style\NumberFormat;
use EphenyxShop\PhenyxSpreadsheet\Style\Style;
use EphenyxShop\PhenyxSpreadsheet\Worksheet\HeaderFooterDrawing;
...
class Xlsx extends BaseReader
{
                                        ...
                                        if (isset($shape['style'])) {
                                            ...
                                            if (($column !== null) && ($row !== null)) {
                                                ...
                                                if (isset($drowingImages[$fillImageRelId])) {
                                                    $objDrawing = new \EphenyxShop\PhenyxSpreadsheet\Worksheet\Drawing();
                ...
                foreach ($is->r as $run) {
                    if (!isset($run->rPr)) {
                        ...
                        if (isset($run->rPr->u)) {
                            ...
                            if (!isset($attr['val'])) {
                                $objFont->setUnderline(\EphenyxShop\PhenyxSpreadsheet\Style\Font::UNDERLINE_SINGLE);
                            } else {
     ...
     */
    private function readHyperLinkDrawing(\EphenyxShop\PhenyxSpreadsheet\Worksheet\Drawing $objDrawing, SimpleXMLElement $cellAnchor, $hyperlinks): void
    {
