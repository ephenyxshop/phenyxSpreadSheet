...
class Xlsx extends BaseReader {
                                    ...
                                    if (isset($shape['style'])) {
                                        ...
                                        if (($column !== null) && ($row !== null)) {
                                            ...
                                            if (isset($drowingImages[$fillImageRelId])) {
                                                $objDrawing = new \PhpOffice\PhenyxSpreadsheet\Worksheet\Drawing();
                ...
                foreach ($is->r as $run) {
                    ...
                    if (!isset($run->rPr)) {
                        ...
                        if (isset($run->rPr->u)) {
                            ...
                            if (!isset($attr['val'])) {
                                $objText->getFont()->setUnderline(\PhpOffice\PhenyxSpreadsheet\Style\Font::UNDERLINE_SINGLE);
                            } else {
     ...
     */
    private function readHyperLinkDrawing(\PhpOffice\PhenyxSpreadsheet\Worksheet\Drawing $objDrawing, SimpleXMLElement $cellAnchor, $hyperlinks) : void{
    ...
    private function readAutoFilterTables(
        ...
        } else if ($xmlSheet && $xmlSheet->tableParts && $xmlSheet->tableParts['count'] > 0) {
