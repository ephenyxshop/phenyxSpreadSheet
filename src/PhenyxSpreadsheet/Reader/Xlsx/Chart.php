...
use EphenyxShop\PhenyxSpreadsheet\Chart\ChartColor;
...
use EphenyxShop\PhenyxSpreadsheet\Chart\Properties as ChartProperties;
use EphenyxShop\PhenyxSpreadsheet\Chart\Title;
use EphenyxShop\PhenyxSpreadsheet\Chart\TrendLine;
...
class Chart
{
     ...
     *
     * @return \EphenyxShop\PhenyxSpreadsheet\Chart\Chart
     */
    public function readChart(SimpleXMLElement $chartElements, $chartName)
    {
        ...
        $chart = new \EphenyxShop\PhenyxSpreadsheet\Chart\Chart($chartName, $title, $legend, $plotArea, $plotVisOnly, (string) $dispBlanksAs, $XaxisLabel, $YaxisLabel, $xAxis, $yAxis);
        if ($chartNoFill) {
