...
class Calculation {
    ...
    private static $phpSpreadsheetFunctions = [
        'ABS'                      => [
            ...
            'functionCall'  => [MathTrig\Absolute::, 'evaluate'],
            'argumentCount' => '1',
        ],
        'ACCRINT'                  => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\Securities\AccruedInterest::, 'periodic'],
            'argumentCount' => '4-8',
        ],
        'ACCRINTM'                 => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\Securities\AccruedInterest::, 'atMaturity'],
            'argumentCount' => '3-5',
        ],
        'ACOS'                     => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Trig\Cosine::, 'acos'],
            'argumentCount' => '1',
        ],
        'ACOSH'                    => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Trig\Cosine::, 'acosh'],
            'argumentCount' => '1',
        ],
        'ACOT'                     => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Trig\Cotangent::, 'acot'],
            'argumentCount' => '1',
        ],
        'ACOTH'                    => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Trig\Cotangent::, 'acoth'],
            'argumentCount' => '1',
        ],
        'ADDRESS'                  => [
            'category'      => Category::CATEGORY_LOOKUP_AND_REFERENCE,
            'functionCall'  => [LookupRef\Address::, 'cell'],
            'argumentCount' => '2-5',
        ],
        'AGGREGATE'                => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
        ...
        'AMORDEGRC'                => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\Amortization::, 'AMORDEGRC'],
            'argumentCount' => '6,7',
        ],
        'AMORLINC'                 => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\Amortization::, 'AMORLINC'],
            'argumentCount' => '6,7',
        ],
        'AND'                      => [
            'category'      => Category::CATEGORY_LOGICAL,
            'functionCall'  => [Logical\Operations::, 'logicalAnd'],
            'argumentCount' => '1+',
        ],
        'ARABIC'                   => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Arabic::, 'evaluate'],
            'argumentCount' => '1',
        ],
        'AREAS'                    => [
            'category'      => Category::CATEGORY_LOOKUP_AND_REFERENCE,
        ...
        'ASIN'                     => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Trig\Sine::, 'asin'],
            'argumentCount' => '1',
        ],
        'ASINH'                    => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Trig\Sine::, 'asinh'],
            'argumentCount' => '1',
        ],
        'ATAN'                     => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Trig\Tangent::, 'atan'],
            'argumentCount' => '1',
        ],
        'ATAN2'                    => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Trig\Tangent::, 'atan2'],
            'argumentCount' => '2',
        ],
        'ATANH'                    => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Trig\Tangent::, 'atanh'],
            'argumentCount' => '1',
        ],
        'AVEDEV'                   => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Averages::, 'averageDeviations'],
            'argumentCount' => '1+',
        ],
        'AVERAGE'                  => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Averages::, 'average'],
            'argumentCount' => '1+',
        ],
        'AVERAGEA'                 => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Averages::, 'averageA'],
            'argumentCount' => '1+',
        ],
        'AVERAGEIF'                => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Conditional::, 'AVERAGEIF'],
            'argumentCount' => '2,3',
        ],
        'AVERAGEIFS'               => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Conditional::, 'AVERAGEIFS'],
            'argumentCount' => '3+',
        ],
        'BAHTTEXT'                 => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
        ...
        'BASE'                     => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Base::, 'evaluate'],
            'argumentCount' => '2,3',
        ],
        'BESSELI'                  => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\BesselI::, 'BESSELI'],
            'argumentCount' => '2',
        ],
        'BESSELJ'                  => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\BesselJ::, 'BESSELJ'],
            'argumentCount' => '2',
        ],
        'BESSELK'                  => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\BesselK::, 'BESSELK'],
            'argumentCount' => '2',
        ],
        'BESSELY'                  => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\BesselY::, 'BESSELY'],
            'argumentCount' => '2',
        ],
        'BETADIST'                 => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\Beta::, 'distribution'],
            'argumentCount' => '3-5',
        ],
        'BETA.DIST'                => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'BETAINV'                  => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\Beta::, 'inverse'],
            'argumentCount' => '3-5',
        ],
        'BETA.INV'                 => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'BIN2DEC'                  => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ConvertBinary::, 'toDecimal'],
            'argumentCount' => '1',
        ],
        'BIN2HEX'                  => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ConvertBinary::, 'toHex'],
            'argumentCount' => '1,2',
        ],
        'BIN2OCT'                  => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ConvertBinary::, 'toOctal'],
            'argumentCount' => '1,2',
        ],
        'BINOMDIST'                => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\Binomial::, 'distribution'],
            'argumentCount' => '4',
        ],
        'BINOM.DIST'               => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'BINOM.DIST.RANGE'         => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\Binomial::, 'range'],
            'argumentCount' => '3,4',
        ],
        'BINOM.INV'                => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\Binomial::, 'inverse'],
            'argumentCount' => '3',
        ],
        'BITAND'                   => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\BitWise::, 'BITAND'],
            'argumentCount' => '2',
        ],
        'BITOR'                    => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\BitWise::, 'BITOR'],
            'argumentCount' => '2',
        ],
        'BITXOR'                   => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\BitWise::, 'BITXOR'],
            'argumentCount' => '2',
        ],
        'BITLSHIFT'                => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\BitWise::, 'BITLSHIFT'],
            'argumentCount' => '2',
        ],
        'BITRSHIFT'                => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\BitWise::, 'BITRSHIFT'],
            'argumentCount' => '2',
        ],
        'CEILING'                  => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Ceiling::, 'ceiling'],
            'argumentCount' => '1-2', // 2 for Excel, 1-2 for Ods/Gnumeric
        ],
        'CEILING.MATH'             => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Ceiling::, 'math'],
            'argumentCount' => '1-3',
        ],
        'CEILING.PRECISE'          => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Ceiling::, 'precise'],
            'argumentCount' => '1,2',
        ],
        'CELL'                     => [
        ...
        'CHAR'                     => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
            'functionCall'  => [TextData\CharacterConvert::, 'character'],
            'argumentCount' => '1',
        ],
        'CHIDIST'                  => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\ChiSquared::, 'distributionRightTail'],
            'argumentCount' => '2',
        ],
        'CHISQ.DIST'               => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\ChiSquared::, 'distributionLeftTail'],
            'argumentCount' => '3',
        ],
        'CHISQ.DIST.RT'            => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'CHIINV'                   => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\ChiSquared::, 'inverseRightTail'],
            'argumentCount' => '2',
        ],
        'CHISQ.INV'                => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\ChiSquared::, 'inverseLeftTail'],
            'argumentCount' => '2',
        ],
        'CHISQ.INV.RT'             => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'CHITEST'                  => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\ChiSquared::, 'test'],
            'argumentCount' => '2',
        ],
        'CHISQ.TEST'               => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'CHOOSE'                   => [
            'category'      => Category::CATEGORY_LOOKUP_AND_REFERENCE,
            'functionCall'  => [LookupRef\Selection::, 'CHOOSE'],
            'argumentCount' => '2+',
        ],
        'CLEAN'                    => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
            'functionCall'  => [TextData\Trim::, 'nonPrintable'],
            'argumentCount' => '1',
        ],
        'CODE'                     => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
            'functionCall'  => [TextData\CharacterConvert::, 'code'],
            'argumentCount' => '1',
        ],
        'COLUMN'                   => [
            'category'          => Category::CATEGORY_LOOKUP_AND_REFERENCE,
            'functionCall'      => [LookupRef\RowColumnInformation::, 'COLUMN'],
            'argumentCount'     => '-1',
        ...
        'COLUMNS'                  => [
            'category'      => Category::CATEGORY_LOOKUP_AND_REFERENCE,
            'functionCall'  => [LookupRef\RowColumnInformation::, 'COLUMNS'],
            'argumentCount' => '1',
        ],
        'COMBIN'                   => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Combinations::, 'withoutRepetition'],
            'argumentCount' => '2',
        ],
        'COMBINA'                  => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Combinations::, 'withRepetition'],
            'argumentCount' => '2',
        ],
        'COMPLEX'                  => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\Complex::, 'COMPLEX'],
            'argumentCount' => '2,3',
        ],
        'CONCAT'                   => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
            'functionCall'  => [TextData\Concatenate::, 'CONCATENATE'],
            'argumentCount' => '1+',
        ],
        'CONCATENATE'              => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
        ...
        'CONFIDENCE'               => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Confidence::, 'CONFIDENCE'],
            'argumentCount' => '3',
        ],
        'CONFIDENCE.NORM'          => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'CONVERT'                  => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ConvertUOM::, 'CONVERT'],
            'argumentCount' => '3',
        ],
        'CORREL'                   => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Trends::, 'CORREL'],
            'argumentCount' => '2',
        ],
        'COS'                      => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Trig\Cosine::, 'cos'],
            'argumentCount' => '1',
        ],
        'COSH'                     => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Trig\Cosine::, 'cosh'],
            'argumentCount' => '1',
        ],
        'COT'                      => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Trig\Cotangent::, 'cot'],
            'argumentCount' => '1',
        ],
        'COTH'                     => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Trig\Cotangent::, 'coth'],
            'argumentCount' => '1',
        ],
        'COUNT'                    => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Counts::, 'COUNT'],
            'argumentCount' => '1+',
        ],
        'COUNTA'                   => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Counts::, 'COUNTA'],
            'argumentCount' => '1+',
        ],
        'COUNTBLANK'               => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Counts::, 'COUNTBLANK'],
            'argumentCount' => '1',
        ],
        'COUNTIF'                  => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Conditional::, 'COUNTIF'],
            'argumentCount' => '2',
        ],
        'COUNTIFS'                 => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Conditional::, 'COUNTIFS'],
            'argumentCount' => '2+',
        ],
        'COUPDAYBS'                => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\Coupons::, 'COUPDAYBS'],
            'argumentCount' => '3,4',
        ],
        'COUPDAYS'                 => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\Coupons::, 'COUPDAYS'],
            'argumentCount' => '3,4',
        ],
        'COUPDAYSNC'               => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\Coupons::, 'COUPDAYSNC'],
            'argumentCount' => '3,4',
        ],
        'COUPNCD'                  => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\Coupons::, 'COUPNCD'],
            'argumentCount' => '3,4',
        ],
        'COUPNUM'                  => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\Coupons::, 'COUPNUM'],
            'argumentCount' => '3,4',
        ],
        'COUPPCD'                  => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\Coupons::, 'COUPPCD'],
            'argumentCount' => '3,4',
        ],
        'COVAR'                    => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Trends::, 'COVAR'],
            'argumentCount' => '2',
        ],
        'COVARIANCE.P'             => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'CSC'                      => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Trig\Cosecant::, 'csc'],
            'argumentCount' => '1',
        ],
        'CSCH'                     => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Trig\Cosecant::, 'csch'],
            'argumentCount' => '1',
        ],
        'CUBEKPIMEMBER'            => [
        ...
        'CUMIPMT'                  => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\CashFlow\Constant\Periodic\Cumulative::, 'interest'],
            'argumentCount' => '6',
        ],
        'CUMPRINC'                 => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\CashFlow\Constant\Periodic\Cumulative::, 'principal'],
            'argumentCount' => '6',
        ],
        'DATE'                     => [
            'category'      => Category::CATEGORY_DATE_AND_TIME,
            'functionCall'  => [DateTimeExcel\Date::, 'fromYMD'],
            'argumentCount' => '3',
        ],
        'DATEDIF'                  => [
            'category'      => Category::CATEGORY_DATE_AND_TIME,
            'functionCall'  => [DateTimeExcel\Difference::, 'interval'],
            'argumentCount' => '2,3',
        ],
        'DATESTRING'               => [
            'category'      => Category::CATEGORY_DATE_AND_TIME,
        ...
        'DATEVALUE'                => [
            'category'      => Category::CATEGORY_DATE_AND_TIME,
            'functionCall'  => [DateTimeExcel\DateValue::, 'fromString'],
            'argumentCount' => '1',
        ],
        'DAVERAGE'                 => [
            'category'      => Category::CATEGORY_DATABASE,
            'functionCall'  => [Database\DAverage::, 'evaluate'],
            'argumentCount' => '3',
        ],
        'DAY'                      => [
            'category'      => Category::CATEGORY_DATE_AND_TIME,
            'functionCall'  => [DateTimeExcel\DateParts::, 'day'],
            'argumentCount' => '1',
        ],
        'DAYS'                     => [
            'category'      => Category::CATEGORY_DATE_AND_TIME,
            'functionCall'  => [DateTimeExcel\Days::, 'between'],
            'argumentCount' => '2',
        ],
        'DAYS360'                  => [
            'category'      => Category::CATEGORY_DATE_AND_TIME,
            'functionCall'  => [DateTimeExcel\Days360::, 'between'],
            'argumentCount' => '2,3',
        ],
        'DB'                       => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\Depreciation::, 'DB'],
            'argumentCount' => '4,5',
        ],
        'DBCS'                     => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
        ...
        'DCOUNT'                   => [
            'category'      => Category::CATEGORY_DATABASE,
            'functionCall'  => [Database\DCount::, 'evaluate'],
            'argumentCount' => '3',
        ],
        'DCOUNTA'                  => [
            'category'      => Category::CATEGORY_DATABASE,
            'functionCall'  => [Database\DCountA::, 'evaluate'],
            'argumentCount' => '3',
        ],
        'DDB'                      => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\Depreciation::, 'DDB'],
            'argumentCount' => '4,5',
        ],
        'DEC2BIN'                  => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ConvertDecimal::, 'toBinary'],
            'argumentCount' => '1,2',
        ],
        'DEC2HEX'                  => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ConvertDecimal::, 'toHex'],
            'argumentCount' => '1,2',
        ],
        'DEC2OCT'                  => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ConvertDecimal::, 'toOctal'],
            'argumentCount' => '1,2',
        ],
        'DECIMAL'                  => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
        ...
        'DEGREES'                  => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Angle::, 'toDegrees'],
            'argumentCount' => '1',
        ],
        'DELTA'                    => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\Compare::, 'DELTA'],
            'argumentCount' => '1,2',
        ],
        'DEVSQ'                    => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Deviations::, 'sumSquares'],
            'argumentCount' => '1+',
        ],
        'DGET'                     => [
            'category'      => Category::CATEGORY_DATABASE,
            'functionCall'  => [Database\DGet::, 'evaluate'],
            'argumentCount' => '3',
        ],
        'DISC'                     => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\Securities\Rates::, 'discount'],
            'argumentCount' => '4,5',
        ],
        'DMAX'                     => [
            'category'      => Category::CATEGORY_DATABASE,
            'functionCall'  => [Database\DMax::, 'evaluate'],
            'argumentCount' => '3',
        ],
        'DMIN'                     => [
            'category'      => Category::CATEGORY_DATABASE,
            'functionCall'  => [Database\DMin::, 'evaluate'],
            'argumentCount' => '3',
        ],
        'DOLLAR'                   => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
            'functionCall'  => [TextData\Format::, 'DOLLAR'],
            'argumentCount' => '1,2',
        ],
        'DOLLARDE'                 => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\Dollar::, 'decimal'],
            'argumentCount' => '2',
        ],
        'DOLLARFR'                 => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\Dollar::, 'fractional'],
            'argumentCount' => '2',
        ],
        'DPRODUCT'                 => [
            'category'      => Category::CATEGORY_DATABASE,
            'functionCall'  => [Database\DProduct::, 'evaluate'],
            'argumentCount' => '3',
        ],
        'DSTDEV'                   => [
            'category'      => Category::CATEGORY_DATABASE,
            'functionCall'  => [Database\DStDev::, 'evaluate'],
            'argumentCount' => '3',
        ],
        'DSTDEVP'                  => [
            'category'      => Category::CATEGORY_DATABASE,
            'functionCall'  => [Database\DStDevP::, 'evaluate'],
            'argumentCount' => '3',
        ],
        'DSUM'                     => [
            'category'      => Category::CATEGORY_DATABASE,
            'functionCall'  => [Database\DSum::, 'evaluate'],
            'argumentCount' => '3',
        ],
        'DURATION'                 => [
            'category'      => Category::CATEGORY_FINANCIAL,
        ...
        'DVAR'                     => [
            'category'      => Category::CATEGORY_DATABASE,
            'functionCall'  => [Database\DVar::, 'evaluate'],
            'argumentCount' => '3',
        ],
        'DVARP'                    => [
            'category'      => Category::CATEGORY_DATABASE,
            'functionCall'  => [Database\DVarP::, 'evaluate'],
            'argumentCount' => '3',
        ],
        'ECMA.CEILING'             => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
        ...
        'EDATE'                    => [
            'category'      => Category::CATEGORY_DATE_AND_TIME,
            'functionCall'  => [DateTimeExcel\Month::, 'adjust'],
            'argumentCount' => '2',
        ],
        'EFFECT'                   => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\InterestRate::, 'effective'],
            'argumentCount' => '2',
        ],
        'ENCODEURL'                => [
            'category'      => Category::CATEGORY_WEB,
            'functionCall'  => [Web\Service::, 'urlEncode'],
            'argumentCount' => '1',
        ],
        'EOMONTH'                  => [
            'category'      => Category::CATEGORY_DATE_AND_TIME,
            'functionCall'  => [DateTimeExcel\Month::, 'lastDay'],
            'argumentCount' => '2',
        ],
        'ERF'                      => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\Erf::, 'ERF'],
            'argumentCount' => '1,2',
        ],
        'ERF.PRECISE'              => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\Erf::, 'ERFPRECISE'],
            'argumentCount' => '1',
        ],
        'ERFC'                     => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ErfC::, 'ERFC'],
            'argumentCount' => '1',
        ],
        'ERFC.PRECISE'             => [
            'category'      => Category::CATEGORY_ENGINEERING,
        ...
        'ERROR.TYPE'               => [
            'category'      => Category::CATEGORY_INFORMATION,
            'functionCall'  => [Information\ExcelError::, 'type'],
            'argumentCount' => '1',
        ],
        'EVEN'                     => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Round::, 'even'],
            'argumentCount' => '1',
        ],
        'EXACT'                    => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
            'functionCall'  => [TextData\Text::, 'exact'],
            'argumentCount' => '2',
        ],
        'EXP'                      => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Exp::, 'evaluate'],
            'argumentCount' => '1',
        ],
        'EXPONDIST'                => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\Exponential::, 'distribution'],
            'argumentCount' => '3',
        ],
        'EXPON.DIST'               => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'FACT'                     => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Factorial::, 'fact'],
            'argumentCount' => '1',
        ],
        'FACTDOUBLE'               => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Factorial::, 'factDouble'],
            'argumentCount' => '1',
        ],
        'FALSE'                    => [
            'category'      => Category::CATEGORY_LOGICAL,
            'functionCall'  => [Logical\Boolean::, 'FALSE'],
            'argumentCount' => '0',
        ],
        'FDIST'                    => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'F.DIST'                   => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\F::, 'distribution'],
            'argumentCount' => '4',
        ],
        'F.DIST.RT'                => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'FILTER'                   => [
            'category'      => Category::CATEGORY_LOOKUP_AND_REFERENCE,
            'functionCall'  => [LookupRef\Filter::, 'filter'],
            'argumentCount' => '2-3',
        ],
        'FILTERXML'                => [
            'category'      => Category::CATEGORY_WEB,
        ...
        'FIND'                     => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
            'functionCall'  => [TextData\Search::, 'sensitive'],
            'argumentCount' => '2,3',
        ],
        'FINDB'                    => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
        ...
        'FISHER'                   => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\Fisher::, 'distribution'],
            'argumentCount' => '1',
        ],
        'FISHERINV'                => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\Fisher::, 'inverse'],
            'argumentCount' => '1',
        ],
        'FIXED'                    => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
            'functionCall'  => [TextData\Format::, 'FIXEDFORMAT'],
            'argumentCount' => '1-3',
        ],
        'FLOOR'                    => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Floor::, 'floor'],
            'argumentCount' => '1-2', // Excel requries 2, Ods/Gnumeric 1-2
        ],
        'FLOOR.MATH'               => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Floor::, 'math'],
            'argumentCount' => '1-3',
        ],
        'FLOOR.PRECISE'            => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Floor::, 'precise'],
            'argumentCount' => '1-2',
        ],
        'FORECAST'                 => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Trends::, 'FORECAST'],
            'argumentCount' => '3',
        ],
        'FORECAST.ETS'             => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'FORMULATEXT'              => [
            'category'          => Category::CATEGORY_LOOKUP_AND_REFERENCE,
            'functionCall'      => [LookupRef\Formula::, 'text'],
            'argumentCount'     => '1',
            'passCellReference' => true,
            'passByReference'   => [true],
        ],
        ...
        'FV'                       => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\CashFlow\Constant\Periodic::, 'futureValue'],
            'argumentCount' => '3-5',
        ],
        'FVSCHEDULE'               => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\CashFlow\Single::, 'futureValue'],
            'argumentCount' => '2',
        ],
        'GAMMA'                    => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\Gamma::, 'gamma'],
            'argumentCount' => '1',
        ],
        'GAMMADIST'                => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\Gamma::, 'distribution'],
            'argumentCount' => '4',
        ],
        'GAMMA.DIST'               => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'GAMMAINV'                 => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\Gamma::, 'inverse'],
            'argumentCount' => '3',
        ],
        'GAMMA.INV'                => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'GAMMALN'                  => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\Gamma::, 'ln'],
            'argumentCount' => '1',
        ],
        'GAMMALN.PRECISE'          => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'GAUSS'                    => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\StandardNormal::, 'gauss'],
            'argumentCount' => '1',
        ],
        'GCD'                      => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Gcd::, 'evaluate'],
            'argumentCount' => '1+',
        ],
        'GEOMEAN'                  => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Averages\Mean::, 'geometric'],
            'argumentCount' => '1+',
        ],
        'GESTEP'                   => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\Compare::, 'GESTEP'],
            'argumentCount' => '1,2',
        ],
        'GETPIVOTDATA'             => [
            'category'      => Category::CATEGORY_LOOKUP_AND_REFERENCE,
        ...
        'GROWTH'                   => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Trends::, 'GROWTH'],
            'argumentCount' => '1-4',
        ],
        'HARMEAN'                  => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Averages\Mean::, 'harmonic'],
            'argumentCount' => '1+',
        ],
        'HEX2BIN'                  => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ConvertHex::, 'toBinary'],
            'argumentCount' => '1,2',
        ],
        'HEX2DEC'                  => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ConvertHex::, 'toDecimal'],
            'argumentCount' => '1',
        ],
        'HEX2OCT'                  => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ConvertHex::, 'toOctal'],
            'argumentCount' => '1,2',
        ],
        'HLOOKUP'                  => [
            'category'      => Category::CATEGORY_LOOKUP_AND_REFERENCE,
            'functionCall'  => [LookupRef\HLookup::, 'lookup'],
            'argumentCount' => '3,4',
        ],
        'HOUR'                     => [
            'category'      => Category::CATEGORY_DATE_AND_TIME,
            'functionCall'  => [DateTimeExcel\TimeParts::, 'hour'],
            'argumentCount' => '1',
        ],
        'HYPERLINK'                => [
            'category'          => Category::CATEGORY_LOOKUP_AND_REFERENCE,
            'functionCall'      => [LookupRef\Hyperlink::, 'set'],
            'argumentCount'     => '1,2',
            'passCellReference' => true,
        ],
        'HYPGEOMDIST'              => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\HyperGeometric::, 'distribution'],
            'argumentCount' => '4',
        ],
        'HYPGEOM.DIST'             => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'IF'                       => [
            'category'      => Category::CATEGORY_LOGICAL,
            'functionCall'  => [Logical\Conditional::, 'statementIf'],
            'argumentCount' => '1-3',
        ],
        'IFERROR'                  => [
            'category'      => Category::CATEGORY_LOGICAL,
            'functionCall'  => [Logical\Conditional::, 'IFERROR'],
            'argumentCount' => '2',
        ],
        'IFNA'                     => [
            'category'      => Category::CATEGORY_LOGICAL,
            'functionCall'  => [Logical\Conditional::, 'IFNA'],
            'argumentCount' => '2',
        ],
        'IFS'                      => [
            'category'      => Category::CATEGORY_LOGICAL,
            'functionCall'  => [Logical\Conditional::, 'IFS'],
            'argumentCount' => '2+',
        ],
        'IMABS'                    => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ComplexFunctions::, 'IMABS'],
            'argumentCount' => '1',
        ],
        'IMAGINARY'                => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\Complex::, 'IMAGINARY'],
            'argumentCount' => '1',
        ],
        'IMARGUMENT'               => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ComplexFunctions::, 'IMARGUMENT'],
            'argumentCount' => '1',
        ],
        'IMCONJUGATE'              => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ComplexFunctions::, 'IMCONJUGATE'],
            'argumentCount' => '1',
        ],
        'IMCOS'                    => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ComplexFunctions::, 'IMCOS'],
            'argumentCount' => '1',
        ],
        'IMCOSH'                   => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ComplexFunctions::, 'IMCOSH'],
            'argumentCount' => '1',
        ],
        'IMCOT'                    => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ComplexFunctions::, 'IMCOT'],
            'argumentCount' => '1',
        ],
        'IMCSC'                    => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ComplexFunctions::, 'IMCSC'],
            'argumentCount' => '1',
        ],
        'IMCSCH'                   => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ComplexFunctions::, 'IMCSCH'],
            'argumentCount' => '1',
        ],
        'IMDIV'                    => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ComplexOperations::, 'IMDIV'],
            'argumentCount' => '2',
        ],
        'IMEXP'                    => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ComplexFunctions::, 'IMEXP'],
            'argumentCount' => '1',
        ],
        'IMLN'                     => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ComplexFunctions::, 'IMLN'],
            'argumentCount' => '1',
        ],
        'IMLOG10'                  => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ComplexFunctions::, 'IMLOG10'],
            'argumentCount' => '1',
        ],
        'IMLOG2'                   => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ComplexFunctions::, 'IMLOG2'],
            'argumentCount' => '1',
        ],
        'IMPOWER'                  => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ComplexFunctions::, 'IMPOWER'],
            'argumentCount' => '2',
        ],
        'IMPRODUCT'                => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ComplexOperations::, 'IMPRODUCT'],
            'argumentCount' => '1+',
        ],
        'IMREAL'                   => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\Complex::, 'IMREAL'],
            'argumentCount' => '1',
        ],
        'IMSEC'                    => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ComplexFunctions::, 'IMSEC'],
            'argumentCount' => '1',
        ],
        'IMSECH'                   => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ComplexFunctions::, 'IMSECH'],
            'argumentCount' => '1',
        ],
        'IMSIN'                    => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ComplexFunctions::, 'IMSIN'],
            'argumentCount' => '1',
        ],
        'IMSINH'                   => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ComplexFunctions::, 'IMSINH'],
            'argumentCount' => '1',
        ],
        'IMSQRT'                   => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ComplexFunctions::, 'IMSQRT'],
            'argumentCount' => '1',
        ],
        'IMSUB'                    => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ComplexOperations::, 'IMSUB'],
            'argumentCount' => '2',
        ],
        'IMSUM'                    => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ComplexOperations::, 'IMSUM'],
            'argumentCount' => '1+',
        ],
        'IMTAN'                    => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ComplexFunctions::, 'IMTAN'],
            'argumentCount' => '1',
        ],
        'INDEX'                    => [
            'category'      => Category::CATEGORY_LOOKUP_AND_REFERENCE,
            'functionCall'  => [LookupRef\Matrix::, 'index'],
            'argumentCount' => '1-4',
        ],
        'INDIRECT'                 => [
            'category'          => Category::CATEGORY_LOOKUP_AND_REFERENCE,
            'functionCall'      => [LookupRef\Indirect::, 'INDIRECT'],
            'argumentCount'     => '1,2',
            'passCellReference' => true,
        ],
        'INFO'                     => [
        ...
        'INT'                      => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\IntClass::, 'evaluate'],
            'argumentCount' => '1',
        ],
        'INTERCEPT'                => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Trends::, 'INTERCEPT'],
            'argumentCount' => '2',
        ],
        'INTRATE'                  => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\Securities\Rates::, 'interest'],
            'argumentCount' => '4,5',
        ],
        'IPMT'                     => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\CashFlow\Constant\Periodic\Interest::, 'payment'],
            'argumentCount' => '4-6',
        ],
        'IRR'                      => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\CashFlow\Variable\Periodic::, 'rate'],
            'argumentCount' => '1,2',
        ],
        'ISBLANK'                  => [
            'category'      => Category::CATEGORY_INFORMATION,
            'functionCall'  => [Information\Value::, 'isBlank'],
            'argumentCount' => '1',
        ],
        'ISERR'                    => [
            'category'      => Category::CATEGORY_INFORMATION,
            'functionCall'  => [Information\ErrorValue::, 'isErr'],
            'argumentCount' => '1',
        ],
        'ISERROR'                  => [
            'category'      => Category::CATEGORY_INFORMATION,
            'functionCall'  => [Information\ErrorValue::, 'isError'],
            'argumentCount' => '1',
        ],
        'ISEVEN'                   => [
            'category'      => Category::CATEGORY_INFORMATION,
            'functionCall'  => [Information\Value::, 'isEven'],
            'argumentCount' => '1',
        ],
        'ISFORMULA'                => [
            'category'          => Category::CATEGORY_INFORMATION,
            'functionCall'      => [Information\Value::, 'isFormula'],
            'argumentCount'     => '1',
            'passCellReference' => true,
            'passByReference'   => [true],
        ],
        'ISLOGICAL'                => [
            'category'      => Category::CATEGORY_INFORMATION,
            'functionCall'  => [Information\Value::, 'isLogical'],
            'argumentCount' => '1',
        ],
        'ISNA'                     => [
            'category'      => Category::CATEGORY_INFORMATION,
            'functionCall'  => [Information\ErrorValue::, 'isNa'],
            'argumentCount' => '1',
        ],
        'ISNONTEXT'                => [
            'category'      => Category::CATEGORY_INFORMATION,
            'functionCall'  => [Information\Value::, 'isNonText'],
            'argumentCount' => '1',
        ],
        'ISNUMBER'                 => [
            'category'      => Category::CATEGORY_INFORMATION,
            'functionCall'  => [Information\Value::, 'isNumber'],
            'argumentCount' => '1',
        ],
        'ISO.CEILING'              => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
        ...
        'ISODD'                    => [
            'category'      => Category::CATEGORY_INFORMATION,
            'functionCall'  => [Information\Value::, 'isOdd'],
            'argumentCount' => '1',
        ],
        'ISOWEEKNUM'               => [
            'category'      => Category::CATEGORY_DATE_AND_TIME,
            'functionCall'  => [DateTimeExcel\Week::, 'isoWeekNumber'],
            'argumentCount' => '1',
        ],
        'ISPMT'                    => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\CashFlow\Constant\Periodic\Interest::, 'schedulePayment'],
            'argumentCount' => '4',
        ],
        'ISREF'                    => [
            'category'          => Category::CATEGORY_INFORMATION,
            'functionCall'      => [Information\Value::, 'isRef'],
            'argumentCount'     => '1',
            'passCellReference' => true,
            'passByReference'   => [true],
        ],
        'ISTEXT'                   => [
            'category'      => Category::CATEGORY_INFORMATION,
            'functionCall'  => [Information\Value::, 'isText'],
            'argumentCount' => '1',
        ],
        'ISTHAIDIGIT'              => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
        ...
        'KURT'                     => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Deviations::, 'kurtosis'],
            'argumentCount' => '1+',
        ],
        'LARGE'                    => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Size::, 'large'],
            'argumentCount' => '2',
        ],
        'LCM'                      => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Lcm::, 'evaluate'],
            'argumentCount' => '1+',
        ],
        'LEFT'                     => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
            'functionCall'  => [TextData\Extract::, 'left'],
            'argumentCount' => '1,2',
        ],
        'LEFTB'                    => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
        ...
        'LEN'                      => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
            'functionCall'  => [TextData\Text::, 'length'],
            'argumentCount' => '1',
        ],
        'LENB'                     => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
        ...
        'LINEST'                   => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Trends::, 'LINEST'],
            'argumentCount' => '1-4',
        ],
        'LN'                       => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Logarithms::, 'natural'],
            'argumentCount' => '1',
        ],
        'LOG'                      => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Logarithms::, 'withBase'],
            'argumentCount' => '1,2',
        ],
        'LOG10'                    => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Logarithms::, 'base10'],
            'argumentCount' => '1',
        ],
        'LOGEST'                   => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Trends::, 'LOGEST'],
            'argumentCount' => '1-4',
        ],
        'LOGINV'                   => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\LogNormal::, 'inverse'],
            'argumentCount' => '3',
        ],
        'LOGNORMDIST'              => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\LogNormal::, 'cumulative'],
            'argumentCount' => '3',
        ],
        'LOGNORM.DIST'             => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\LogNormal::, 'distribution'],
            'argumentCount' => '4',
        ],
        'LOGNORM.INV'              => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'LOOKUP'                   => [
            'category'      => Category::CATEGORY_LOOKUP_AND_REFERENCE,
            'functionCall'  => [LookupRef\Lookup::, 'lookup'],
            'argumentCount' => '2,3',
        ],
        'LOWER'                    => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
            'functionCall'  => [TextData\CaseConvert::, 'lower'],
            'argumentCount' => '1',
        ],
        'MATCH'                    => [
            'category'      => Category::CATEGORY_LOOKUP_AND_REFERENCE,
            'functionCall'  => [LookupRef\ExcelMatch::, 'MATCH'],
            'argumentCount' => '2,3',
        ],
        'MAX'                      => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Maximum::, 'max'],
            'argumentCount' => '1+',
        ],
        'MAXA'                     => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Maximum::, 'maxA'],
            'argumentCount' => '1+',
        ],
        'MAXIFS'                   => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Conditional::, 'MAXIFS'],
            'argumentCount' => '3+',
        ],
        'MDETERM'                  => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\MatrixFunctions::, 'determinant'],
            'argumentCount' => '1',
        ],
        'MDURATION'                => [
            'category'      => Category::CATEGORY_FINANCIAL,
        ...
        'MEDIAN'                   => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Averages::, 'median'],
            'argumentCount' => '1+',
        ],
        'MEDIANIF'                 => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'MID'                      => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
            'functionCall'  => [TextData\Extract::, 'mid'],
            'argumentCount' => '3',
        ],
        'MIDB'                     => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
        ...
        'MIN'                      => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Minimum::, 'min'],
            'argumentCount' => '1+',
        ],
        'MINA'                     => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Minimum::, 'minA'],
            'argumentCount' => '1+',
        ],
        'MINIFS'                   => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Conditional::, 'MINIFS'],
            'argumentCount' => '3+',
        ],
        'MINUTE'                   => [
            'category'      => Category::CATEGORY_DATE_AND_TIME,
            'functionCall'  => [DateTimeExcel\TimeParts::, 'minute'],
            'argumentCount' => '1',
        ],
        'MINVERSE'                 => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\MatrixFunctions::, 'inverse'],
            'argumentCount' => '1',
        ],
        'MIRR'                     => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\CashFlow\Variable\Periodic::, 'modifiedRate'],
            'argumentCount' => '3',
        ],
        'MMULT'                    => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\MatrixFunctions::, 'multiply'],
            'argumentCount' => '2',
        ],
        'MOD'                      => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Operations::, 'mod'],
            'argumentCount' => '2',
        ],
        'MODE'                     => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Averages::, 'mode'],
            'argumentCount' => '1+',
        ],
        'MODE.MULT'                => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'MONTH'                    => [
            'category'      => Category::CATEGORY_DATE_AND_TIME,
            'functionCall'  => [DateTimeExcel\DateParts::, 'month'],
            'argumentCount' => '1',
        ],
        'MROUND'                   => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Round::, 'multiple'],
            'argumentCount' => '2',
        ],
        'MULTINOMIAL'              => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Factorial::, 'multinomial'],
            'argumentCount' => '1+',
        ],
        'MUNIT'                    => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\MatrixFunctions::, 'identity'],
            'argumentCount' => '1',
        ],
        'N'                        => [
            'category'      => Category::CATEGORY_INFORMATION,
            'functionCall'  => [Information\Value::, 'asNumber'],
            'argumentCount' => '1',
        ],
        'NA'                       => [
            'category'      => Category::CATEGORY_INFORMATION,
            'functionCall'  => [Information\ExcelError::, 'NA'],
            'argumentCount' => '0',
        ],
        'NEGBINOMDIST'             => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\Binomial::, 'negative'],
            'argumentCount' => '3',
        ],
        'NEGBINOM.DIST'            => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'NETWORKDAYS'              => [
            'category'      => Category::CATEGORY_DATE_AND_TIME,
            'functionCall'  => [DateTimeExcel\NetworkDays::, 'count'],
            'argumentCount' => '2-3',
        ],
        'NETWORKDAYS.INTL'         => [
            'category'      => Category::CATEGORY_DATE_AND_TIME,
        ...
        'NOMINAL'                  => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\InterestRate::, 'nominal'],
            'argumentCount' => '2',
        ],
        'NORMDIST'                 => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\Normal::, 'distribution'],
            'argumentCount' => '4',
        ],
        'NORM.DIST'                => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'NORMINV'                  => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\Normal::, 'inverse'],
            'argumentCount' => '3',
        ],
        'NORM.INV'                 => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'NORMSDIST'                => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\StandardNormal::, 'cumulative'],
            'argumentCount' => '1',
        ],
        'NORM.S.DIST'              => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\StandardNormal::, 'distribution'],
            'argumentCount' => '1,2',
        ],
        'NORMSINV'                 => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\StandardNormal::, 'inverse'],
            'argumentCount' => '1',
        ],
        'NORM.S.INV'               => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'NOT'                      => [
            'category'      => Category::CATEGORY_LOGICAL,
            'functionCall'  => [Logical\Operations::, 'NOT'],
            'argumentCount' => '1',
        ],
        'NOW'                      => [
            'category'      => Category::CATEGORY_DATE_AND_TIME,
            'functionCall'  => [DateTimeExcel\Current::, 'now'],
            'argumentCount' => '0',
        ],
        'NPER'                     => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\CashFlow\Constant\Periodic::, 'periods'],
            'argumentCount' => '3-5',
        ],
        'NPV'                      => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\CashFlow\Variable\Periodic::, 'presentValue'],
            'argumentCount' => '2+',
        ],
        'NUMBERSTRING'             => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
        ...
        'NUMBERVALUE'              => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
            'functionCall'  => [TextData\Format::, 'NUMBERVALUE'],
            'argumentCount' => '1+',
        ],
        'OCT2BIN'                  => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ConvertOctal::, 'toBinary'],
            'argumentCount' => '1,2',
        ],
        'OCT2DEC'                  => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ConvertOctal::, 'toDecimal'],
            'argumentCount' => '1',
        ],
        'OCT2HEX'                  => [
            'category'      => Category::CATEGORY_ENGINEERING,
            'functionCall'  => [Engineering\ConvertOctal::, 'toHex'],
            'argumentCount' => '1,2',
        ],
        'ODD'                      => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Round::, 'odd'],
            'argumentCount' => '1',
        ],
        'ODDFPRICE'                => [
            'category'      => Category::CATEGORY_FINANCIAL,
        ...
        'OFFSET'                   => [
            'category'          => Category::CATEGORY_LOOKUP_AND_REFERENCE,
            'functionCall'      => [LookupRef\Offset::, 'OFFSET'],
            'argumentCount'     => '3-5',
            'passCellReference' => true,
            'passByReference'   => [true],
        ],
        'OR'                       => [
            'category'      => Category::CATEGORY_LOGICAL,
            'functionCall'  => [Logical\Operations::, 'logicalOr'],
            'argumentCount' => '1+',
        ],
        'PDURATION'                => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\CashFlow\Single::, 'periods'],
            'argumentCount' => '3',
        ],
        'PEARSON'                  => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'PERCENTILE'               => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Percentiles::, 'PERCENTILE'],
            'argumentCount' => '2',
        ],
        'PERCENTILE.EXC'           => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'PERCENTRANK'              => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Percentiles::, 'PERCENTRANK'],
            'argumentCount' => '2,3',
        ],
        'PERCENTRANK.EXC'          => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'PERMUT'                   => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Permutations::, 'PERMUT'],
            'argumentCount' => '2',
        ],
        'PERMUTATIONA'             => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Permutations::, 'PERMUTATIONA'],
            'argumentCount' => '2',
        ],
        'PHONETIC'                 => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
        ...
        'PMT'                      => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\CashFlow\Constant\Periodic\Payments::, 'annuity'],
            'argumentCount' => '3-5',
        ],
        'POISSON'                  => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\Poisson::, 'distribution'],
            'argumentCount' => '3',
        ],
        'POISSON.DIST'             => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'POWER'                    => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Operations::, 'power'],
            'argumentCount' => '2',
        ],
        'PPMT'                     => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\CashFlow\Constant\Periodic\Payments::, 'interestPayment'],
            'argumentCount' => '4-6',
        ],
        'PRICE'                    => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\Securities\Price::, 'price'],
            'argumentCount' => '6,7',
        ],
        'PRICEDISC'                => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\Securities\Price::, 'priceDiscounted'],
            'argumentCount' => '4,5',
        ],
        'PRICEMAT'                 => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\Securities\Price::, 'priceAtMaturity'],
            'argumentCount' => '5,6',
        ],
        'PROB'                     => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'PRODUCT'                  => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Operations::, 'product'],
            'argumentCount' => '1+',
        ],
        'PROPER'                   => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
            'functionCall'  => [TextData\CaseConvert::, 'proper'],
            'argumentCount' => '1',
        ],
        'PV'                       => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\CashFlow\Constant\Periodic::, 'presentValue'],
            'argumentCount' => '3-5',
        ],
        'QUARTILE'                 => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Percentiles::, 'QUARTILE'],
            'argumentCount' => '2',
        ],
        'QUARTILE.EXC'             => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'QUOTIENT'                 => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Operations::, 'quotient'],
            'argumentCount' => '2',
        ],
        'RADIANS'                  => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Angle::, 'toRadians'],
            'argumentCount' => '1',
        ],
        'RAND'                     => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Random::, 'rand'],
            'argumentCount' => '0',
        ],
        'RANDARRAY'                => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Random::, 'randArray'],
            'argumentCount' => '0-5',
        ],
        'RANDBETWEEN'              => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Random::, 'randBetween'],
            'argumentCount' => '2',
        ],
        'RANK'                     => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Percentiles::, 'RANK'],
            'argumentCount' => '2,3',
        ],
        'RANK.AVG'                 => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'RATE'                     => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\CashFlow\Constant\Periodic\Interest::, 'rate'],
            'argumentCount' => '3-6',
        ],
        'RECEIVED'                 => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\Securities\Price::, 'received'],
            'argumentCount' => '4-5',
        ],
        'REPLACE'                  => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
            'functionCall'  => [TextData\Replace::, 'replace'],
            'argumentCount' => '4',
        ],
        'REPLACEB'                 => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
        ...
        'REPT'                     => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
            'functionCall'  => [TextData\Concatenate::, 'builtinREPT'],
            'argumentCount' => '2',
        ],
        'RIGHT'                    => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
            'functionCall'  => [TextData\Extract::, 'right'],
            'argumentCount' => '1,2',
        ],
        'RIGHTB'                   => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
        ...
        'ROMAN'                    => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Roman::, 'evaluate'],
            'argumentCount' => '1,2',
        ],
        'ROUND'                    => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Round::, 'round'],
            'argumentCount' => '2',
        ],
        'ROUNDBAHTDOWN'            => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
        ...
        'ROUNDDOWN'                => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Round::, 'down'],
            'argumentCount' => '2',
        ],
        'ROUNDUP'                  => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Round::, 'up'],
            'argumentCount' => '2',
        ],
        'ROW'                      => [
            'category'          => Category::CATEGORY_LOOKUP_AND_REFERENCE,
            'functionCall'      => [LookupRef\RowColumnInformation::, 'ROW'],
            'argumentCount'     => '-1',
            'passCellReference' => true,
            'passByReference'   => [true],
        ],
        'ROWS'                     => [
            'category'      => Category::CATEGORY_LOOKUP_AND_REFERENCE,
            'functionCall'  => [LookupRef\RowColumnInformation::, 'ROWS'],
            'argumentCount' => '1',
        ],
        'RRI'                      => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\CashFlow\Single::, 'interestRate'],
            'argumentCount' => '3',
        ],
        'RSQ'                      => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Trends::, 'RSQ'],
            'argumentCount' => '2',
        ],
        'RTD'                      => [
            'category'      => Category::CATEGORY_LOOKUP_AND_REFERENCE,
        ...
        'SEARCH'                   => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
            'functionCall'  => [TextData\Search::, 'insensitive'],
            'argumentCount' => '2,3',
        ],
        'SEARCHB'                  => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
        ...
        'SEC'                      => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Trig\Secant::, 'sec'],
            'argumentCount' => '1',
        ],
        'SECH'                     => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Trig\Secant::, 'sech'],
            'argumentCount' => '1',
        ],
        'SECOND'                   => [
            'category'      => Category::CATEGORY_DATE_AND_TIME,
            'functionCall'  => [DateTimeExcel\TimeParts::, 'second'],
            'argumentCount' => '1',
        ],
        'SEQUENCE'                 => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\MatrixFunctions::, 'sequence'],
            'argumentCount' => '1-4',
        ],
        'SERIESSUM'                => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\SeriesSum::, 'evaluate'],
            'argumentCount' => '4',
        ],
        'SHEET'                    => [
            'category'      => Category::CATEGORY_INFORMATION,
        ...
        'SIGN'                     => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Sign::, 'evaluate'],
            'argumentCount' => '1',
        ],
        'SIN'                      => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Trig\Sine::, 'sin'],
            'argumentCount' => '1',
        ],
        'SINH'                     => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Trig\Sine::, 'sinh'],
            'argumentCount' => '1',
        ],
        'SKEW'                     => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Deviations::, 'skew'],
            'argumentCount' => '1+',
        ],
        'SKEW.P'                   => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'SLN'                      => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\Depreciation::, 'SLN'],
            'argumentCount' => '3',
        ],
        'SLOPE'                    => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Trends::, 'SLOPE'],
            'argumentCount' => '2',
        ],
        'SMALL'                    => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Size::, 'small'],
            'argumentCount' => '2',
        ],
        'SORT'                     => [
            'category'      => Category::CATEGORY_LOOKUP_AND_REFERENCE,
            'functionCall'  => [LookupRef\Sort::, 'sort'],
            'argumentCount' => '1-4',
        ],
        'SORTBY'                   => [
            'category'      => Category::CATEGORY_LOOKUP_AND_REFERENCE,
            'functionCall'  => [LookupRef\Sort::, 'sortBy'],
            'argumentCount' => '2+',
        ],
        'SQRT'                     => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Sqrt::, 'sqrt'],
            'argumentCount' => '1',
        ],
        'SQRTPI'                   => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Sqrt::, 'pi'],
            'argumentCount' => '1',
        ],
        'STANDARDIZE'              => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Standardize::, 'execute'],
            'argumentCount' => '3',
        ],
        'STDEV'                    => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\StandardDeviations::, 'STDEV'],
            'argumentCount' => '1+',
        ],
        'STDEV.S'                  => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'STDEV.P'                  => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\StandardDeviations::, 'STDEVP'],
            'argumentCount' => '1+',
        ],
        'STDEVA'                   => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\StandardDeviations::, 'STDEVA'],
            'argumentCount' => '1+',
        ],
        'STDEVP'                   => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'STDEVPA'                  => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\StandardDeviations::, 'STDEVPA'],
            'argumentCount' => '1+',
        ],
        'STEYX'                    => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Trends::, 'STEYX'],
            'argumentCount' => '2',
        ],
        'SUBSTITUTE'               => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
            'functionCall'  => [TextData\Replace::, 'substitute'],
            'argumentCount' => '3,4',
        ],
        'SUBTOTAL'                 => [
            'category'          => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'      => [MathTrig\Subtotal::, 'evaluate'],
            'argumentCount'     => '2+',
            'passCellReference' => true,
        ],
        'SUM'                      => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Sum::, 'sumErroringStrings'],
            'argumentCount' => '1+',
        ],
        'SUMIF'                    => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [Statistical\Conditional::, 'SUMIF'],
            'argumentCount' => '2,3',
        ],
        'SUMIFS'                   => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [Statistical\Conditional::, 'SUMIFS'],
            'argumentCount' => '3+',
        ],
        'SUMPRODUCT'               => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Sum::, 'product'],
            'argumentCount' => '1+',
        ],
        'SUMSQ'                    => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\SumSquares::, 'sumSquare'],
            'argumentCount' => '1+',
        ],
        'SUMX2MY2'                 => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\SumSquares::, 'sumXSquaredMinusYSquared'],
            'argumentCount' => '2',
        ],
        'SUMX2PY2'                 => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\SumSquares::, 'sumXSquaredPlusYSquared'],
            'argumentCount' => '2',
        ],
        'SUMXMY2'                  => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\SumSquares::, 'sumXMinusYSquared'],
            'argumentCount' => '2',
        ],
        'SWITCH'                   => [
            'category'      => Category::CATEGORY_LOGICAL,
            'functionCall'  => [Logical\Conditional::, 'statementSwitch'],
            'argumentCount' => '3+',
        ],
        'SYD'                      => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\Depreciation::, 'SYD'],
            'argumentCount' => '4',
        ],
        'T'                        => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
            'functionCall'  => [TextData\Text::, 'test'],
            'argumentCount' => '1',
        ],
        'TAN'                      => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Trig\Tangent::, 'tan'],
            'argumentCount' => '1',
        ],
        'TANH'                     => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Trig\Tangent::, 'tanh'],
            'argumentCount' => '1',
        ],
        'TBILLEQ'                  => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\TreasuryBill::, 'bondEquivalentYield'],
            'argumentCount' => '3',
        ],
        'TBILLPRICE'               => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\TreasuryBill::, 'price'],
            'argumentCount' => '3',
        ],
        'TBILLYIELD'               => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\TreasuryBill::, 'yield'],
            'argumentCount' => '3',
        ],
        'TDIST'                    => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\StudentT::, 'distribution'],
            'argumentCount' => '3',
        ],
        'T.DIST'                   => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'TEXT'                     => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
            'functionCall'  => [TextData\Format::, 'TEXTFORMAT'],
            'argumentCount' => '2',
        ],
        'TEXTJOIN'                 => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
            'functionCall'  => [TextData\Concatenate::, 'TEXTJOIN'],
            'argumentCount' => '3+',
        ],
        'THAIDAYOFWEEK'            => [
            'category'      => Category::CATEGORY_DATE_AND_TIME,
        ...
        'TIME'                     => [
            'category'      => Category::CATEGORY_DATE_AND_TIME,
            'functionCall'  => [DateTimeExcel\Time::, 'fromHMS'],
            'argumentCount' => '3',
        ],
        'TIMEVALUE'                => [
            'category'      => Category::CATEGORY_DATE_AND_TIME,
            'functionCall'  => [DateTimeExcel\TimeValue::, 'fromString'],
            'argumentCount' => '1',
        ],
        'TINV'                     => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\StudentT::, 'inverse'],
            'argumentCount' => '2',
        ],
        'T.INV'                    => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'TODAY'                    => [
            'category'      => Category::CATEGORY_DATE_AND_TIME,
            'functionCall'  => [DateTimeExcel\Current::, 'today'],
            'argumentCount' => '0',
        ],
        'TRANSPOSE'                => [
            'category'      => Category::CATEGORY_LOOKUP_AND_REFERENCE,
            'functionCall'  => [LookupRef\Matrix::, 'transpose'],
            'argumentCount' => '1',
        ],
        'TREND'                    => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Trends::, 'TREND'],
            'argumentCount' => '1-4',
        ],
        'TRIM'                     => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
            'functionCall'  => [TextData\Trim::, 'spaces'],
            'argumentCount' => '1',
        ],
        'TRIMMEAN'                 => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Averages\Mean::, 'trim'],
            'argumentCount' => '2',
        ],
        'TRUE'                     => [
            'category'      => Category::CATEGORY_LOGICAL,
            'functionCall'  => [Logical\Boolean::, 'TRUE'],
            'argumentCount' => '0',
        ],
        'TRUNC'                    => [
            'category'      => Category::CATEGORY_MATH_AND_TRIG,
            'functionCall'  => [MathTrig\Trunc::, 'evaluate'],
            'argumentCount' => '1,2',
        ],
        'TTEST'                    => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'TYPE'                     => [
            'category'      => Category::CATEGORY_INFORMATION,
            'functionCall'  => [Information\Value::, 'type'],
            'argumentCount' => '1',
        ],
        'UNICHAR'                  => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
        ...
        'UNIQUE'                   => [
            'category'      => Category::CATEGORY_LOOKUP_AND_REFERENCE,
            'functionCall'  => [LookupRef\Unique::, 'unique'],
            'argumentCount' => '1+',
        ],
        'UPPER'                    => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
            'functionCall'  => [TextData\CaseConvert::, 'upper'],
            'argumentCount' => '1',
        ],
        'USDOLLAR'                 => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\Dollar::, 'format'],
            'argumentCount' => '2',
        ],
        'VALUE'                    => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
            'functionCall'  => [TextData\Format::, 'VALUE'],
            'argumentCount' => '1',
        ],
        'VALUETOTEXT'              => [
            'category'      => Category::CATEGORY_TEXT_AND_DATA,
        ...
        'VAR'                      => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Variances::, 'VAR'],
            'argumentCount' => '1+',
        ],
        'VAR.P'                    => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Variances::, 'VARP'],
            'argumentCount' => '1+',
        ],
        'VAR.S'                    => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'VARA'                     => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Variances::, 'VARA'],
            'argumentCount' => '1+',
        ],
        'VARP'                     => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'VARPA'                    => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Variances::, 'VARPA'],
            'argumentCount' => '1+',
        ],
        'VDB'                      => [
            'category'      => Category::CATEGORY_FINANCIAL,
        ...
        'VLOOKUP'                  => [
            'category'      => Category::CATEGORY_LOOKUP_AND_REFERENCE,
            'functionCall'  => [LookupRef\VLookup::, 'lookup'],
            'argumentCount' => '3,4',
        ],
        'WEBSERVICE'               => [
            'category'      => Category::CATEGORY_WEB,
            'functionCall'  => [Web\Service::, 'webService'],
            'argumentCount' => '1',
        ],
        'WEEKDAY'                  => [
            'category'      => Category::CATEGORY_DATE_AND_TIME,
            'functionCall'  => [DateTimeExcel\Week::, 'day'],
            'argumentCount' => '1,2',
        ],
        'WEEKNUM'                  => [
            'category'      => Category::CATEGORY_DATE_AND_TIME,
            'functionCall'  => [DateTimeExcel\Week::, 'number'],
            'argumentCount' => '1,2',
        ],
        'WEIBULL'                  => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\Weibull::, 'distribution'],
            'argumentCount' => '4',
        ],
        'WEIBULL.DIST'             => [
            'category'      => Category::CATEGORY_STATISTICAL,
        ...
        'WORKDAY'                  => [
            'category'      => Category::CATEGORY_DATE_AND_TIME,
            'functionCall'  => [DateTimeExcel\WorkDay::, 'date'],
            'argumentCount' => '2-3',
        ],
        'WORKDAY.INTL'             => [
            'category'      => Category::CATEGORY_DATE_AND_TIME,
        ...
        'XIRR'                     => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\CashFlow\Variable\NonPeriodic::, 'rate'],
            'argumentCount' => '2,3',
        ],
        'XLOOKUP'                  => [
            'category'      => Category::CATEGORY_LOOKUP_AND_REFERENCE,
        ...
        'XNPV'                     => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\CashFlow\Variable\NonPeriodic::, 'presentValue'],
            'argumentCount' => '3',
        ],
        'XMATCH'                   => [
            'category'      => Category::CATEGORY_LOOKUP_AND_REFERENCE,
        ...
        'XOR'                      => [
            'category'      => Category::CATEGORY_LOGICAL,
            'functionCall'  => [Logical\Operations::, 'logicalXor'],
            'argumentCount' => '1+',
        ],
        'YEAR'                     => [
            'category'      => Category::CATEGORY_DATE_AND_TIME,
            'functionCall'  => [DateTimeExcel\DateParts::, 'year'],
            'argumentCount' => '1',
        ],
        'YEARFRAC'                 => [
            'category'      => Category::CATEGORY_DATE_AND_TIME,
            'functionCall'  => [DateTimeExcel\YearFrac::, 'fraction'],
            'argumentCount' => '2,3',
        ],
        'YIELD'                    => [
            'category'      => Category::CATEGORY_FINANCIAL,
        ...
        'YIELDDISC'                => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\Securities\Yields::, 'yieldDiscounted'],
            'argumentCount' => '4,5',
        ],
        'YIELDMAT'                 => [
            'category'      => Category::CATEGORY_FINANCIAL,
            'functionCall'  => [Financial\Securities\Yields::, 'yieldAtMaturity'],
            'argumentCount' => '5,6',
        ],
        'ZTEST'                    => [
            'category'      => Category::CATEGORY_STATISTICAL,
            'functionCall'  => [Statistical\Distributions\StandardNormal::, 'zTest'],
            'argumentCount' => '2-3',
        ],
        'Z.TEST'                   => [
            'category'      => Category::CATEGORY_STATISTICAL,
    ...
    private static $controlFunctions = [
        'MKMATRIX'      => [
            'argumentCount' => '*',
            'functionCall'  => [Internal\MakeMatrix::, 'make'],
        ],
        'NAME.ERROR'    => [
            'argumentCount' => '*',
            'functionCall'  => [Functions::, 'NAME'],
        ],
        'WILDCARDMATCH' => [
            'argumentCount' => '2',
            'functionCall'  => [Internal\WildcardMatch::, 'compare'],
        ],
    ];
    ...
    private function internalParseFormula($formula,  ? Cell $cell = null) {
        ...
        while (true) {
            ...
            if ($opCharacter == '-' && !$expectingOperator) {
            ...
            } else if ((($opCharacter == '~') || ($opCharacter == '∩') || ($opCharacter == '∪')) && (!$isOperandOrFunction)) { //    We have to explicitly deny a tilde, union or intersect because they are legal
                return $this->raiseFormulaError("Formula Error: Illegal character '~'"); //        on the stack but not in the input expression
            } else if ((isset(self::$operators[$opCharacter]) || $isOperandOrFunction) && $expectingOperator) {
                ...
                ++$index;
            } else if ($isOperandOrFunction && !$expectingOperator) {
        ...
        if (is_string($operand)) {
            ...
            if (!is_numeric($operand)) {
                ...
                if ($operand > '' && $operand[0] == '#') {
                    ...
                    return false;
                } else if (!Shared\StringHelper::convertToNumberIfFraction($operand)) {
