...
class Font extends Supervisor {
     ...
     *         'bold' => TRUE,
     *         'italic' => FALSE,
     *         'underline' => \PhpOffice\PhenyxSpreadsheet\Style\Font::UNDERLINE_DOUBLE,
     *         'strikethrough' => FALSE,
     *         'color' => [
     *             'rgb' => '808080'
     *         ]
     ...
     * Set Underline.
     *
     * @param bool|string $underlineStyle \PhpOffice\PhenyxSpreadsheet\Style\Font underline type
