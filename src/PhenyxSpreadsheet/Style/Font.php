...
class Font extends Supervisor
{
     ...
     *         'bold' => TRUE,
     *         'italic' => FALSE,
     *         'underline' => \EphenyxShop\PhenyxSpreadsheet\Style\Font::UNDERLINE_DOUBLE,
     *         'strikethrough' => FALSE,
     *         'color' => [
     *             'rgb' => '808080'
     *         ]
     ...
     * Set Underline.
     *
     * @param bool|string $underlineStyle \EphenyxShop\PhenyxSpreadsheet\Style\Font underline type
